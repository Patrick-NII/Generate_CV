...
domaines = [
    ...
    'Immobilier', 'Assistance', 'Social', 'Culture', 'Recherche', 'Enseignement'
]
...
prenoms_pays = {
    ...
    # Ajoutez d'autres pays et prénoms si nécessaire
}
...
competences_techniques = {
    ...
    'RH': ['Recrutement', 'Formation', 'Gestion de carrière', 'Gestion de paie', 'Gestion des conflits'],
...
descriptions_postes = {
    ...
    'Transport': [
        "Conduite et pilotage des véhicules",
        "Gestion des itinéraires et des horaires",
        "Maintenance et entretien des véhicules",
        "Sécurité et respect des règles de circulation",
        "Relation client et service à bord"
    ],
    'Technologies': [
        "Développement et maintenance des applications web",
        "Analyse des besoins des utilisateurs et conception des solutions logicielles",
